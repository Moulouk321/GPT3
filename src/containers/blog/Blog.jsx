...
import { Article } from '../../components' //the same as import Article from '../../components/article/Article'
  ...
  return (
    <div className='gpt3__blog section__padding' id='blog'>
      <div className='gpt3__blog-heading'>
        <h1 className='gradient__text fs-62 lh-75'>A lot is happening, We are blogging about it.</h1>
      </div>
